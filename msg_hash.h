...
enum msg_hash_enums
{
   ...
   MENU_LABEL(NETPLAY_GGPO_DISCONNECT_TIMEOUT),
   MENU_LABEL(NETPLAY_GGPO_DISCONNECT_NOTIFY_START),
   MENU_LABEL(NETPLAY_GGPO_LZ4_ACCEL),
   MENU_LABEL(NETPLAY_GGPO_SEND_INTERVAL),
   MENU_LABEL(NETPLAY_GGPO_MAX_INPUT_BITS),
   MENU_LABEL(NETPLAY_GGPO_PREDICTION_FRAMES),
   MENU_LABEL(NETPLAY_GGPO_NETWORK_DELAY),
   MENU_LABEL(NETPLAY_GGPO_OOP_PERCENT),
   ...
   MENU_LABEL(NETPLAY_GGPO_STATS_SHOW),
   ...
   MENU_LABEL(NETPLAY_USE_RENDEZVOUS),
   MENU_LABEL(NETPLAY_USE_GGPO_RELAY),
   MENU_LABEL(NETPLAY_MITM_SERVER),
   MENU_ENUM_LABEL_NETPLAY_MITM_SERVER_LOCATION,
   MENU_LABEL(NETPLAY_CUSTOM_MITM_SERVER),
   MENU_LABEL(NETPLAY_RENDEZVOUS_SERVER),
   MENU_LABEL(NETPLAY_RENDEZVOUS_PORT),
   MENU_LABEL(NETPLAY_RENDEZVOUS_ROOM),
   MENU_LABEL(NETPLAY_GGPO_RELAY_SERVER),
   MENU_LABEL(NETPLAY_GGPO_RELAY_PORT),
   MENU_LABEL(NETPLAY_GGPO_RELAY_SESSION),
