...
#define DEFAULT_NETPLAY_USE_RENDEZVOUS false

#define DEFAULT_NETPLAY_USE_GGPO_RELAY false

#define DEFAULT_NETPLAY_USE_GGPO false

#define DEFAULT_NETPLAY_MITM_SERVER "nyc"

#define DEFAULT_NETPLAY_MITM_SESSION ""

#define DEFAULT_NETPLAY_RENDEZVOUS_SERVER ""

#define DEFAULT_NETPLAY_RENDEZVOUS_ROOM "retroarch"

#define DEFAULT_NETPLAY_RENDEZVOUS_PORT 7000

#define DEFAULT_NETPLAY_GGPO_RELAY_SERVER ""

#define DEFAULT_NETPLAY_GGPO_RELAY_SESSION "retroarch"

#define DEFAULT_NETPLAY_GGPO_RELAY_PORT 7001

#define DEFAULT_NETPLAY_GGPO_DISCONNECT_TIMEOUT 3000

#define DEFAULT_NETPLAY_GGPO_DISCONNECT_NOTIFY_START 1000

#define DEFAULT_NETPLAY_GGPO_LZ4_ACCEL 0

#define DEFAULT_NETPLAY_GGPO_NETWORK_DELAY 0

#define DEFAULT_NETPLAY_GGPO_OOP_PERCENT 0

#define DEFAULT_NETPLAY_GGPO_SEND_INTERVAL 0

#define DEFAULT_NETPLAY_GGPO_MAX_INPUT_BITS 0

#define DEFAULT_NETPLAY_GGPO_PREDICTION_FRAMES 0
